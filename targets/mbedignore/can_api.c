...
//0: 优先级由报文的标识符来决定；
//1: 优先级由发送请求的顺序来决定。
    obj->CanHandle.Init.TXFP = ENABLE;//DISABLE;FIFO优先级
